      ...
      >
        ...
        >
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="mt-4 w-full">
                  <div className="flex gap-4 w-full flex-wrap">
                    ...
                    <button
                      onClick={() => {
                        const element = document.getElementById('live-examples');
                        if (element) {
                      ...
                      className="inline-flex items-center px-2 py-1 rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#23272f] text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#33363b] transition-colors duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D4A857] text-xs cursor-pointer"
                      aria-label="View Live Examples"
                    >
                      <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div className="mt-2">
                    <a
                      href="/ai-ux-auditor"
                      className="inline-flex items-center px-2 py-1 rounded-md border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-[#2e2a22] text-amber-900 dark:text-amber-200 hover:bg-amber-100 dark:hover:bg-[#3a3428] transition-colors duration-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#D4A857] text-xs"
                      aria-label="Try my AI UX Audit tool (beta)"
                    >
                      <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path d="M13 3l8 8-1.5 1.5-2.1-2.1-2.6 2.6 2.1 2.1L15.4 17 7 8.6 8.5 7.1l2.1 2.1 2.6-2.6L11.1 4.5 13 3zM5 19h14v2H5z" />
                      </svg>
                      Try My AI UX Audit Tool (Beta)
                      <span className="ml-2 px-1.5 py-0.5 rounded bg-amber-200/70 dark:bg-amber-800/50 text-[10px] font-semibold tracking-wide">
                        Under Construction
                      </span>
                    </a>
                  </div>
          ...
          color: theme === 'dark' ? '#D4A857' : '#000000',
            ...
            <h2 id="live-examples" className="text-4xl font-bold text-center mb-8" style={{ color: theme === 'dark' ? '#D4A857' : '#000000' }}>Live Examples</h2>
            <ClientOnly>
              <ImageCarousel />
            </ClientOnly>
